...
public class EnqueuePHHoldingsRecordAction extends AbstractRawRepoAction {
    ...
    public ServiceResult performAction() throws UpdateException {
        ...
        try {
            String providerId = JNDIResources.RAWREPO_PROVIDER_ID_PH;
            ...
            rawRepo.changedRecord(settings.getProperty(providerId), new RecordId(recordId.getBibliographicRecordId(), recordId.getAgencyId()));
