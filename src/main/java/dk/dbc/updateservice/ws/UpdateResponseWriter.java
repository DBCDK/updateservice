...
public class UpdateResponseWriter {
    ...
    public void setServiceResult(ServiceResult serviceResult) {
        response.setUpdateStatus(serviceResult.getStatus());
        response.setDoubleRecordKey(serviceResult.getDoubleRecordKey());
        addValidateEntries(serviceResult.getEntries());
    }
}
