...
class UpdateServiceCoreTest {
    ...
    void testPutNewFBSEnrichmentNoParent() throws Exception {
        ...
        inOrder.verify(updateServiceCore.rawRepo).enqueue(enrichmentRecordId, "fbs-provider", true, false, 1000);
    ...
    void testPutNewEnrichmentWithParent() throws Exception {
        ...
        inOrder.verify(updateServiceCore.rawRepo).linkRecordAppend(enrichmentRecordId, commonRecordId);
        inOrder.verify(updateServiceCore.rawRepo).enqueue(enrichmentRecordId, "dbc-provider", true, false, 1000);
    ...
    void testPutNewCommonRecordWithAuthority() throws Exception {
        ...
        inOrder.verify(updateServiceCore.rawRepo).enqueue(commonRecordId, "dbc-provider", true, false, 1000);
        inOrder.verifyNoMoreInteractions();
    }
