...
public class UpdateCommonRecordActionTest {
    ...
    public void testPerformAction_CreateSingleRecord() throws Exception {
        ...
        assertThat(updateSingleRecord.state.getUpdateRecordRequest().getAuthentication().getGroupIdAut(), equalTo(GROUP_ID));
    ...
    public void testPerformAction_CreateSingleRecord_WithDoubleAlias() throws Exception {
        ...
        assertThat(updateCommonRecordAction.performAction(), equalTo(ServiceResult.newErrorResult(UpdateStatusEnum.FAILED, message, state)));
    }
    ...
    public void testPerformAction_CreateVolumeRecord() throws Exception {
        ...
        assertThat(updateVolumeRecord.state.getUpdateRecordRequest().getAuthentication().getGroupIdAut(), equalTo(GROUP_ID));
